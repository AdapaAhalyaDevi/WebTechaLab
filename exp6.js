...
function q5() {
document.getElementById("bfr").innerHTML = "Before 2000"; document.getElementById("aft").innerHTML = "After 2000";
let student = [{ name: "Ahalya", regNo: "URK20CS3028", dob: "28/Dec/2002" },
{ name: "Renuka", regNo: "URK20CS3031", dob: "15/May/2003" },
{ name: "Angel", regNo: "URK20CS1161", dob: "23/may/2002" },
{ name: "Deepthi", regNo: "URK20CS1142", dob: "23/Feb/2004" },
]
for (let i = 0; i < student.length; i++) {
if (parseInt(student[i].dob.split("/")[2]) < 2000) { document.getElementById("before").innerHTML += student[i].name + "\'s " + "Register Number is " + student[i].regNo + " and the DOB is " + student[i].dob + "<br><br>";
} else
